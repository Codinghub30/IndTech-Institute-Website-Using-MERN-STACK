...
const Apply = () => {
  return (
    <div className="p-8">
      ...
      <h2 className="text-2xl font-bold mb-4 mt-36 text-center">
        Apply for Admission and Make your Career Bright
      </h2>
      <div className="content-apply flex ml-32">
        ...
        <form
          ...
          style={{ marginLeft: "18%", width: "70%", marginTop: "2%" }}
          action="https://formspree.io/f/xqkrokbg"
          method="POST"
        >
          <div className="mb-4">
            <label
